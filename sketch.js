...
var fundaFreq1 = parseFloat(document.getElementById("fF1").value); // fF1 stands for "fundamantal frequency" and the number is their point in time
var fundaFreq2 = parseFloat(document.getElementById("fF2").value); // you can set the fundamental frequency for each point.
var fundaFreq3 = parseFloat(document.getElementById("fF3").value);
//var fundaFreq4 = parseFloat(document.getElementById("fF4").value);
  
var spacing = parseFloat(document.getElementById("space").value); 
  ...
  var now = audioCtx.currentTime;
   ...
   // emitter.frequency.cancelScheduledValues(now);
    ...
    emitter.frequency.linearRampToValueAtTime(emitter.frequency.value , now + 1.0); 
    
    emitter.frequency.linearRampToValueAtTime(fundaFreq1 , now + 2.0 + spacing); 
    
    emitter.frequency.linearRampToValueAtTime(fundaFreq2 , now + 3.0 + spacing + spacing); 
    
    emitter.frequency.linearRampToValueAtTime(fundaFreq3 , now + 4.0 + spacing + spacing + spacing ); 
